...
export default function ServiceCard({ title, description, image, color, isHovered }) {
  return (
    ...
    >
      ...
      <p className="text-primary-600 text-center leading-relaxed">{description}</p>
      <motion.div
      ...
      >
        <a href="#" className="text-accent-500 font-semibold hover:text-accent-600 transition duration-300">
          Learn More →
        </a>
      </motion.div>
    </motion.div>
