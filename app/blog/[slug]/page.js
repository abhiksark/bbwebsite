...
const components = {
  h1: (props) => (
    <h1 className="text-3xl font-bold my-4 text-primary-900" {...props} />
  ),
  h2: (props) => (
    <h2 className="text-2xl font-semibold my-3 text-primary-800" {...props} />
  ),
  h3: (props) => (
    <h3 className="text-xl font-semibold my-2 text-primary-800" {...props} />
  ),
  p: (props) => <p className="my-2 text-text-700" {...props} />,
  ...
  code: (props) => (
    <code className="bg-primary-50 rounded px-1 py-0.5" {...props} />
  ),
  pre: (props) => (
    <pre className="bg-primary-50 rounded p-4 overflow-x-auto my-4" {...props} />
  ),
};
